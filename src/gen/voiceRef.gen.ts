...
/** The narrator anchor: every VO segment references this comp's voice settings via a
 *  `comp://voiceRef` audio ref, so the film's voice is defined in exactly one place. */
