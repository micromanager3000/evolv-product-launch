...
// asset:// refs resolve through framediff.assets.json + the assets/ CAS, same as the Studio
 ...
 *  derived-output cache, as real files on disk. Returns the content hash. Handy for turning a
 *  finished sub-comp into a portable clip; the generative comps here resolve their `comp://`
 *  refs to pinned takes without any manual bake. */
(window as unknown as Record<string, unknown>).__bake = async (id: string) => {
